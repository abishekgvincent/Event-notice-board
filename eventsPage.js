...
const EventsPage = () => {
  ...
  const fetchEvents = () => {
    ...
    const unsubscribe = onSnapshot(
      ...
      (snapshot) => {
        ...
        // Sort events by startDate and endDate
  ...
  // Handle filtering events for "upcoming" and "previous" views
  useEffect(() => {
    const today = new Date();
    const todayWithoutTime = new Date(today.getFullYear(), today.getMonth(), today.getDate()); // Midnight today
    ...
    <View style={[styles.container, themeStyles]}>
      <View style={styles.buttonsContainer}>
        ...
        <TouchableOpacity onPress={() => toggleViewing('previous')} style={[styles.button, viewing === 'previous' && styles.activeButton]}>
          <Text style={styles.buttonText}>Previous Events</Text>
        </TouchableOpacity>
      </View>
  ...
  ListEmptyComponent={
    <View style={styles.noEventsContainer}>
      <Text style={[styles.noEventsText, themeStyles]}>
        {viewing === 'upcoming' ? 'No upcoming events.' : 'No previous events.'}
      </Text>
    </View>
  }
  refreshControl={
...
>
  ...
  <View style={styles.placeholderImage}>
      ...
      <Text style={styles.modalTime}>Time: {selectedEvent?.time || 'Not Available'}</Text>
      <Text style={styles.modalVenue}>Venue: {selectedEvent?.venue || 'Not Available'}</Text>
